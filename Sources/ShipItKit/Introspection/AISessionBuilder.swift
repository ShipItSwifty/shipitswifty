        ...
        case .ios:
            ...
            if goal == .beta {
                lines += [
                    ...
                    "  (e.g. Config/Version.xcconfig with APP_MARKETING_VERSION / APP_BUILD_NUMBER):",
                    ...
                    "    versioning.marketing_key / build_key: the .xcconfig variable names (e.g. APP_MARKETING_VERSION / APP_BUILD_NUMBER)",
