...
public struct ShipfileSuggester: Sendable {
        ...
        -> SuggestedShipfile
    {
        ...
        if inspection.suggestedAndroidPackageName == nil {
            missingValues.append(
                .init(
                    keyPath: "android.package_name",
                    reason: "Android package name could not be inferred from Gradle or AndroidManifest.xml.",
        ...
        let yaml = renderAndroidYAML(goal: goal, packageName: inspection.suggestedAndroidPackageName)
        return SuggestedShipfile(
            goal: goal, inspection: inspection, missingValues: missingValues, warnings: warnings,
            yaml: yaml)
    }
    ...
    private func renderAndroidYAML(goal: SuggestionGoal, packageName: String?) -> String {
        var lines: [String] = [
            "# Shipfile.yml — generated by `shipit generate`",
            "# Review detected values before committing this file.",
            "platform: android",
            "",
            "android:",
            "  # Optional preview tooling; Gradle/ADB remain the default when disabled.",
            "  # cli: { enabled: true, executable_path: android }",
