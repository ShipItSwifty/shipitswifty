...
public struct ShipfileSuggester: Sendable {
  ...
  public func suggest(goal: SuggestionGoal, platform: Platform, from inspection: ProjectInspection)
    -> SuggestedShipfile
  {
    switch platform {
    case .ios:
  ...
  private func suggestIOS(goal: SuggestionGoal, from inspection: ProjectInspection)
    -> SuggestedShipfile
  {
  ...
  private func suggestAndroid(goal: SuggestionGoal, from inspection: ProjectInspection)
    -> SuggestedShipfile
  {
    var missingValues: [SuggestedShipfile.MissingValue] = []
    var warnings = inspection.warnings
  ...
  private func renderIOSYAML(goal: SuggestionGoal, app: ProjectInspection.SuggestedAppConfig)
    -> String
  {
