...
public struct ConfigResolver: Sendable {
  ...
  private func mergeAppConfig(base: AppConfig?, platform: Platform, shipfile: Shipfile?)
    -> AppConfig?
  {
  ...
  private func mergeBuildConfig(base: BuildConfig?, platform: Platform, shipfile: Shipfile?)
    -> BuildConfig?
  {
