...
|---|:-:|:-:|---|
| ``BuildAction`` | ✅ | ✅ | `xcodebuild build` / `gradlew assemble<Variant>` |
| ``TestAction`` | ✅ | ✅ | Multi-destination on iOS; unit + instrumented on Android |
| ``CoverageAction`` | ✅ | ✅ | Reads `.xcresult` / JaCoCo XML — see <doc:Coverage> |
