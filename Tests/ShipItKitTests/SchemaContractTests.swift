...
struct SchemaContractTests {
    private let builtInActionNames: Set<String> = [
        ...
        AndroidDescribeAction.name,
        AndroidDocsAction.name,
        AndroidEmulatorAction.name,
        AndroidHelpAction.name,
        AndroidInfoAction.name,
        AndroidInitAction.name,
        AndroidInstallAction.name,
        AndroidLayoutAction.name,
        AndroidRunAction.name,
        AndroidSDKAction.name,
        AndroidScreenAction.name,
        AndroidSkillsAction.name,
        AndroidStudioAction.name,
        AndroidUpdateAction.name,
        BuildAction.name,
        CoverageAction.name,
